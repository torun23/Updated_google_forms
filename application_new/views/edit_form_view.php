...
$(document).ready(function() {
    ...
    $('#submit-btn').on('click', function() {
        ...
        $('.form-section').each(function() {
            var $section = $(this);
            var sectionData = {
                text: $section.find('.untitled-question').val(),
                type: $section.find('select').val(),
                is_required: $section.find('.required-toggle').is(':checked'),
                options: []
            };

            $section.find('.option-label').each(function() {
